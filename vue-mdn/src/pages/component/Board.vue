    ...
    <div class="page-component__all">
        <div class="page-component__top-wrap">
            <div class="page-component__title-wrap">
                ...
                <h2 class="page-component__main-tit">게시물</h2>
            </div>
            <div class="page-component-btn-wrap">
                <router-link to="/posting/post?category=board" class="page-component__add-post__btn">게시글 등록</router-link>
            </div>
        </div>
        ...
        <div class="page-component-list__wrap">
            <div class="page-component-list__box">
                ...
                <div v-if="보드_게시물_목록.length === 0" style="padding: 80px 0; text-align: center; color: #888; font-size: 1.2rem; background: #f8f9fa; border-radius: 10px;">
...
// 💡 연습 포인트 2: 자식 부품(컴포넌트)을 꼭 수입(import)해 와야 합니다!
...
export default {
    ...
    data() {
        return {
            // 💡 연습 포인트 3: 이 화면에 보여줄 데이터를 담을 빈 상자를 만듭니다.
            보드_게시물_목록: [] 
        };
    },
    ...
    methods: {
        ...
        게시물_불러오기() {
            ...
            this.보드_게시물_목록 = 전체_게시물.filter(게시물 => 게시물.category === 'board');
        },
