    ...
    <div class="page-component__all">
        <div class="page-component__top-wrap">
            ...
            <div class="page-component-btn-wrap">
                <router-link to="../posting/post?category=coupon" class="page-component__add-post__btn" >게시글 등록</router-link>
            </div>
        </div>
        <div class="page-component-list__wrap">
            <div class="page-component-list__box">
                ...
                <div v-if="쿠폰_게시물_목록.length === 0" style="padding: 80px 0; text-align: center; color: #888; font-size: 1.2rem; background: #f8f9fa; border-radius: 10px;">
...
export default {
    ...
    methods : {
        ...
        게시물_불러오기() {
            ...
            this.쿠폰_게시물_목록 = 전체_게시물.filter(게시물 => 게시물.category === 'coupon');
        },
